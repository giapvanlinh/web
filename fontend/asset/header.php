		...
		<div class="container">
			<div class="row">
				...
				<script type="text/javascript">
					...
					if(s === "điện thoại"){
						<a href="http://localhost:8888/Websosanh/fontend/dienthoai.php"><input type="submit" name="submit" value="Tìm Kiếm" onclick="gettext()"></a>
					}

				}
				</script>

					<input type="text" name="text" placeholder="Tìm sản phẩm muốn so sánh" id="txtname">
					<input type="submit" name="submit" value="Tìm Kiếm" onclick="gettext()">
				</div>
